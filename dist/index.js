...
class TsActionTimerLibrary {
    constructor() {
        this.execution = () => {
            ...
            console.log(timer_1.default.now(), timer_1.default.generateDateFromString(timedAction), timer_1.default.getMsFormated(timer_1.default.getMsFromString(duration)), timer_1.default.toString(new Date(timer_1.default.now().getTime() + timer_1.default.getMsFromString(duration))));
